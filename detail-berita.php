...
<div id="middle-content">
	<div class="rows breadcums">
		<div class="wrapper">
			<ol class="breadcrumb">
			  <li><a href="#">Home</a></li>
			  <li><a href="#">Index Berita Kegiatan	</a></li>
			  <li class="active">Pengembang Kerjasama BSN dan BSI</li>
			</ol>
		</div>
	</div>
				...
				<div class=" col-lg-8 col-md-8">
					<div class="left-content">
						<div class="detail-Berita">
							...
							<div class="main-images"><img src="images/content/detail-news.jpg"></div>
